...
<!-- Ticket Modal for BMI -->
  <div id="ticketModal" class="w3-modal">
   ...
   <input type="number" id="FullName" name="height" placeholder="Enetr your height in meters" maxlength="31"  class="textInput" ng-model="weight"  required />
      <label><b>Weight</b></label>
	 <input type="number" id="FullName" name="weight" placeholder="Enter your weight in kg" maxlength="50"  class="textInput" ng-model="height" required />     
	 <input type="submit" class="w3-btn w3-margin-bottom w3-blue " name="submit" value="submit">
     </form>
	 <div id="result"></div>
  ...
  <div id="ticketModal1" class="w3-modal">
    <div class="w3-modal-content w3-animate-top w3-card-8 ">
	  ...
	  <p style=" text-align: left;"><label><b>Weight:</b></label></p>
        <input class="w3-input w3-border" type="number" placeholder="Enter your weight in kg" name="weight1" required >
...
?>
  ...
  <div id="ticketModal2" class="w3-modal">
    <div class="w3-modal-content w3-animate-top w3-card-8 ">
	 ...
	 <form action="index.php" method="post">
	  <label><b>Height</b></label>
   <input type="number"  name="height1" placeholder="Enetr your height in centimeters" maxlength="31"  class="textInput"  required />
      <label><b>Weight</b></label>
	 <input type="number" name="weight2" placeholder="Enter your weight in kg" maxlength="50"  class="textInput" required />     
	<input type="submit" class="w3-btn w3-margin-bottom w3-blue "  value="submit">
   </form>
   <?php
require("bsa.php");
  ...
  <div id="ticketModal3" class="w3-modal">
    <div class="w3-modal-content w3-animate-top w3-card-8 ">
	 ...
	 <form action="index.php" method="post">
        ...
        <input class="w3-input w3-border" type="number" placeholder="Enter your hip in inches" name="hip" required >
		 <p style=" text-align: left;"><label><b> Waist:</b></label></p>
        <input class="w3-input w3-border" type="number" placeholder="Enter your waist in inches" name="waist" required >
		<p style=" text-align: left;"><label><b>Select your gender:</b></label></p>
		<p align="left"><input type="radio" name="gender1"  value="T">Male<br>
		 <input type="radio"  name="gender1" value="F">Female</p>
		<input type="submit" class="w3-btn w3-margin-bottom w3-blue "  value="submit">
	  </form>
	  <?php
require("whr.php");
?>
  ...
  <div id="ticketModal4" class="w3-modal">
    <div class="w3-modal-content w3-animate-top w3-card-8 ">
	  ...
	  <form action="index.php" method="post">
	  <p style=" text-align: left;"><label><b> Waist:</b></label></p>
        <input class="w3-input w3-border" type="number" placeholder="Enetr your waist in inches" name="waist1" required >
		<label><b>Height</b></label>
   <input type="number"  name="height2" placeholder="Enetr your height in inches" maxlength="31"  class="textInput"  required />
     <p style=" text-align: left;"><label><b>Select your gender:</b></label></p>
		<p align="left"><input type="radio" name="gender2"  value="T">Male<br>
		 <input type="radio"  name="gender2" value="F">Female</p>
		<input type="submit" class="w3-btn w3-margin-bottom w3-blue "  value="submit">
	  </form>
	  <?php
require("whtr.php");
?>
  ...
  <div id="ticketModal5" class="w3-modal">
    <div class="w3-modal-content w3-animate-top w3-card-8 ">
	  ...
	  <form action="index.php" method="post">
	  <p style=" text-align: left;"><label><b>Weight:</b></label></p>
        <input class="w3-input w3-border" type="number" placeholder="Enter your weight in kg" name="weight3" required >
		<p style=" text-align: left;"><label><b>Select your gender:</b></label></p>
		<p align="left"><input type="radio" name="gender3"  value="T">Male<br>
		 <input type="radio"  name="gender3" value="F">Female</p>
...
?>
  ...
  <div id="ticketModal6" class="w3-modal">
    <div class="w3-modal-content w3-animate-top w3-card-8 ">
	  ...
	  <form action="index.php" method="post">
	  <label><b>Height</b></label>
   <input type="number" id="FullName" name="height3" placeholder="Enetr your height in meters" maxlength="31"  class="textInput"  required />
      <label><b>Weight</b></label>
	 <input type="number" id="FullName" name="weight4" placeholder="Enter your weight in kg" maxlength="50"  class="textInput" required />     
	<label><b>Age</b></label>
	 <input type="number" id="FullName" name="age" placeholder="Enter your age" maxlength="50"  class="textInput" required />     
	<p style=" text-align: left;"><label><b>Select your gender:</b></label></p>
		<p align="left"><input type="radio" name="gender4"  value="T">Male<br>
		 <input type="radio"  name="gender4" value="F">Female</p>
		 <input type="submit" class="w3-btn w3-margin-bottom w3-blue "  value="submit">
	  </form>
	<?php
require("fat.php");
...
<!-- Ticket Modal for Calories burned -->	
	<div id="ticketModal7" class="w3-modal">
    <div class="w3-modal-content w3-animate-top w3-card-8 ">
      <header class="w3-container w3-blue w3-center w3-padding-32"> 
        <span onclick="document.getElementById('ticketModal7').style.display='none'" 
       class="w3-closebtn w3-padding-xlarge w3-xxlarge w3-display-topright">×</span>
        <h2 class="w3-wide">Caluculate your Calories burned</h2>
      </header>
      <div class="w3-container">
	  <form action="index.php" method="post">
	  <label><b>Height</b></label>
   <input type="number" id="FullName" name="height4" placeholder="Enetr your height in inches" maxlength="31"  class="textInput"  required />
      <label><b>Weight</b></label>
	 <input type="number" id="FullName" name="weight5" placeholder="Enter your weight in kg" maxlength="50"  class="textInput" required />     
	<label><b>Age</b></label>
	 <input type="number" id="FullName" name="age1" placeholder="Enter your age" maxlength="50"  class="textInput" required />     
	<p style=" text-align: left;"><label><b>Select your gender:</b></label></p>
		<p align="left"><input type="radio" name="gender5"  value="T">Male<br>
		 <input type="radio"  name="gender5" value="F">Female</p>
		 <p style=" text-align: left;"><label><b> Select your activity level:</b></label></p>
...
<!-- Ticket Modal for IBW -->	
<div id="ticketModal8" class="w3-modal">
    <div class="w3-modal-content w3-animate-top w3-card-8 ">
      <header class="w3-container w3-blue w3-center w3-padding-32"> 
        <span onclick="document.getElementById('ticketModal8').style.display='none'" 
       class="w3-closebtn w3-padding-xlarge w3-xxlarge w3-display-topright">×</span>
        <h2 class="w3-wide">Caluculate your IBW</h2>
      </header>
      <div class="w3-container">
	  <form action="index.php" method="post">
	  <label><b>Height</b></label>
   <input type="text" id="FullName" name="height5" placeholder="Enetr your height in feet" maxlength="31"  class="textInput"  required />
          
	<p style=" text-align: left;"><label><b>Select your gender:</b></label></p>
		<p align="left"><input type="radio" name="gender6"  value="T">Male<br>
		 <input type="radio"  name="gender6" value="F">Female</p>
		 <input type="submit" class="w3-btn w3-margin-bottom w3-blue "  value="submit">
	  </form>
	  <?php
require("w.php");
?>
	...
	<!-- Ticket Modal for ABW -->	
<div id="ticketModal9" class="w3-modal">
    <div class="w3-modal-content w3-animate-top w3-card-8 ">
      <header class="w3-container w3-blue w3-center w3-padding-32"> 
        <span onclick="document.getElementById('ticketModal9').style.display='none'" 
       class="w3-closebtn w3-padding-xlarge w3-xxlarge w3-display-topright">×</span>
        <h2 class="w3-wide">Caluculate your ABW</h2>
      </header>
      <div class="w3-container">
	  <form action="index.php" method="post">
	  <label><b>Height</b></label>
   <input type="text" id="FullName" name="height6" placeholder="Enetr your height in feet" maxlength="31"  class="textInput"  required />
   <label><b>Weight</b></label>
   <input type="text" id="FullName" name="weight6" placeholder="Enetr your Weight in kg" maxlength="31"  class="textInput"  required />
          
	<p style=" text-align: left;"><label><b>Select your gender:</b></label></p>
		<p align="left"><input type="radio" name="gender7"  value="T">Male<br>
		 <input type="radio"  name="gender7" value="F">Female</p>
		 <input type="submit" class="w3-btn w3-margin-bottom w3-blue "  value="submit">
	  </form>
	<?php
require("abw.php");
